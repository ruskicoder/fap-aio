/**
 * Timetable component (userscript version)
 * Uses nativeFetch and raw localStorage instead of polyfilled fetch and storage facade
 */
...
import { parseHTML, query, getText } from '../dom-helpers';
