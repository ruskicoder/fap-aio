/**
 * MoveOut Utilities (userscript version)
 * Uses native fetch + DOMParser instead of polyfilled fetch + cheerio
 * Uses raw localStorage instead of storage facade
 */

import { nativeFetch } from '../../nativeFetch';
import { parseHTML, query, queryAll, getText, getAttr } from './dom-helpers';
